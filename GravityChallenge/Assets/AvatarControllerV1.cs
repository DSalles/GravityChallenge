...
public class AvatarControllerV1 : MonoBehaviour
{		
	internal AstroJump astroJump;
	...
	{	
		...
		if (astroJump) {
			astroJump.OldBodyRootPosY = 0;
			astroJump.BodyRootY = 0;

			if(rawImage){rawImage.texture = DefaultAstronautHead;
